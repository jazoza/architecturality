...
"""
---------------------
AUOMATE TWEETS USING MARKOVIFY MODULE (ACTIVEFORM)
---------------------
"""
...
from activeform_auth import TwitterAuth
...
def atd():
    ...
    model_combo = markovify.combine([model_tweets,model_activeform],[1,6])
...
# friendly bots
friendlyBOTS = ['@contagiousarchi', '@infosabundance', '@digitalimmanent', '@digittools', '@a__stack']
def mention():
