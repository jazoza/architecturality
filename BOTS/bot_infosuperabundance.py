...
"""
---------------------
AUOMATE TWEETS USING MARKOVIFY MODULE (INFORMATION SUPERABUNDANCE)
---------------------
"""
...
from infosuperabundance_auth import TwitterAuth
...
def atd():
    ...
    model_combo = markovify.combine([model_tweets,model_superabundance],[1,5])
...
# friendly bots
friendlyBOTS = ['@active_form', '@contagiousarchi', '@digitalimmanent', '@digittools', '@a__stack']
def mention():
