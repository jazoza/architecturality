...
"""
---------------------
AUOMATE TWEETS USING MARKOVIFY MODULE (STACK)
---------------------
"""
...
from stack_auth import TwitterAuth
...
def atd():
    ...
    model_combo = markovify.combine([model_tweets,model_stack],[1,3])
...
# friendly bots
friendlyBOTS = ['@active_form', '@contagiousarchi', '@infosabundance', '@digitalimmanent', '@digittools']
def mention():
