...
"""
---------------------
AUOMATE TWEETS USING MARKOVIFY MODULE (DIGITTOOLS)
---------------------
"""
...
from digitaltools_auth import TwitterAuth
...
def atd():
    ...
    model_combo = markovify.combine([model_tweets,model_digitaltools],[1,15])
...
# friendly bots
friendlyBOTS = ['@active_form', '@contagiousarchi', '@infosabundance', '@digitalimmanent', '@a__stack']
def mention():
