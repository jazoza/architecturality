...
"""
---------------------
AUOMATE TWEETS USING MARKOVIFY MODULE (CONTAGIOUS)
---------------------
"""
...
from contagiousarchi_auth import TwitterAuth
...
def atd():
    ...
    model_combo = markovify.combine([model_tweets,model_contagiousarch],[1,5])
...
# friendly bots
friendlyBOTS = ['@active_form', '@infosabundance', '@digitalimmanent', '@digittools', '@a__stack']
def mention():
